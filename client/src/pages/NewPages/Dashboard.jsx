...
import { FiHome, FiPlus, FiFileText, FiPrinter } from 'react-icons/fi';
    ...
    <div className="flex min-h-screen bg-gray-100 text-gray-200">
      ...
      <div className="flex-1 flex flex-col bg-gray-100 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gray-800 rounded-xl p-6 hover:ring-1 hover:ring-blue-500 transition-all">
            <FiHome className="text-4xl text-blue-400 mb-4" />
            <h3 className="text-xl font-semibold mb-2">Dashboard</h3>
            <p className="text-gray-400 text-sm">View analytics and quick actions</p>
          </div>
